<header id="header" class="container-fluid position-relative p-0 header">
    <nav class="navbar navbar-expand-sm p-sm-0 navbar-light custom-navbar">
        ...
        @else
            <a class="navbar-brand custom-navbar-brand" href="{{ route('home') }}">
                <img src="{{ asset('img/hapo_Learn.png') }}" alt="Hapo_Learn">
            </a>
        @endguest

        <button class="navbar-toggler custom-button-navbar-toggler" type="button" data-toggle="collapse"
            ...
            <ul class="navbar-nav w-100 d-flex justify-content-end">
                @guest
                    <li class="nav-item active">
                        <a class="nav-link text-secondary {{ Route::currentRouteName() == 'home' ? 'active' : '' }}"
                            href="/">HOME</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-secondary {{ Route::currentRouteName() == 'courses.index' || Route::currentRouteName() == 'courses.search' ? 'active' : '' }}"
